...
public partial class Member_Member : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            MemberFormViewSqlDataSource.SelectCommand = string.Format("SELECT * FROM VIP_INFO where VipName='{0}'", Session["MemberName"].ToString().Trim());
