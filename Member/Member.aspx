<%@ Page Title="" Language="C#" MasterPageFile="MemberMaster.master" AutoEventWireup="true" CodeFile="Member.aspx.cs" Inherits="Member_Member" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MemberHeaderContentPlaceHolder" runat="Server">
    <style type="text/css">
        .MemberFV {
            width: 100%;
            margin: 20px 0px;
...
<asp:Content ID="Content1" ContentPlaceHolderID="MemberMainContentPlaceHolder" runat="Server">
    ...
    <div>
        ...
        <div>
            <asp:FormView ID="MemberFormView" runat="server" DataSourceID="MemberFormViewSqlDataSource" DataKeyNames="VipID" OnItemUpdating="MemberFormView_ItemUpdating" CssClass="MemberFV">
                <ItemTemplate>
                    <div>
        ...
        <asp:SqlDataSource ID="MemberFormViewSqlDataSource" UpdateCommand="UPDATE VIP_INFO SET Email=@Email, Province=@Province, City=@City, Address=@Address, Postcode=@Postcode, Telephone=@Telephone, ImageUrl=@ImageUrl WHERE VipID=@VipID" ConnectionString="<%$ ConnectionStrings:db2016ConnectionString %>" runat="server"></asp:SqlDataSource>
    </div>
